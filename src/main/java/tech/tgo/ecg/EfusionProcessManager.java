...
import tech.tgo.ecg.compute.ComputeProcessorAL1;
import tech.tgo.ecg.model.*;
import tech.tgo.ecg.util.ConfigurationException;
import tech.tgo.ecg.util.EfusionValidator;
...
//                computeProcessor.setObservations(this.geoMission.observations);
    ...
    public Thread start() throws Exception {
        ...
        /* Generate FilterExecutions for given Initial State Mode */
//        List<FilterExecution> filterExecutions = initialiseFilterExecutions();
