...
public class TDOAObservationFixITs implements CageListener {
    ...
    public void testMiddle() {
        ...
        //geoMission.setInitialStateMode(InitialStateMode.box_all_out); // correct result
        geoMission.setInitialStateMode(InitialStateMode.top_right); // incorrect result
        geoMission.setFilterDispatchResidualThreshold(10.0);
        geoMission.setDispatchResultsPeriod(100L);
