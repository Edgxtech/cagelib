 ...
 */
public class MovingSimCircularFixITs implements EfusionListener {
    ...
    public void configure() {
        ...
        simulatedAssetObserver.setEfusionProcessManager(efusionProcessManager);
