 ...
 */
public class FundamentalConvergenceTests_1 implements EfusionListener {

    private static final Logger log = LoggerFactory.getLogger(tech.tgo.ecg.cdt.FundamentalConvergenceTests_1.class);
